...
class BEiT3ForValenceArousalRegression(BEiT3Wrapper):
    ...
    def forward(self, image, text_description=None, padding_mask=None, image_mask=None, **kwargs):
        """
        Forward pass supporting multimodal, text-only, or image-only inputs.
        Optional arguments default to None to handle missing modalities or masks.
        """
